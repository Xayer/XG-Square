...
public class Character : MonoBehaviour
{
    ...
    void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        if (hit.gameObject.GetComponent<CountDownExplosive>() != null && hit.gameObject.GetComponent<CountDownExplosive>().avtivateByPlayerContact)
        ...
        else if (hit.gameObject.GetComponent<Explosive>() != null && hit.gameObject.GetComponent<Explosive>().avtivateByPlayerContact)
            // Explode nitro
